...
NPC_ISCharacterProtection = ISPanelJoypad:derive("NPC_ISCharacterProtection");

local FONT_HGT_SMALL = getTextManager():getFontHeight(UIFont.Small)
local FONT_HGT_MEDIUM = getTextManager():getFontHeight(UIFont.Medium)

function NPC_ISCharacterProtection:initialise()
	ISPanelJoypad.initialise(self);
	self:create();
end

function NPC_ISCharacterProtection:createChildren()
...
function NPC_ISCharacterProtection:setVisible(visible)
	if visible then
		-- init?
	end
...
function NPC_ISCharacterProtection:prerender()
	ISPanelJoypad.prerender(self)
end

function NPC_ISCharacterProtection:render()
...
--[[
function NPC_ISCharacterProtection:getProtectionRGB(totalProtection)
...
function NPC_ISCharacterProtection:create()
	self:initTextures();
...
function NPC_ISCharacterProtection:initTextures()
    self.bparts = {};
...
function NPC_ISCharacterProtection:onJoypadDown(button)
...
function NPC_ISCharacterProtection:new(x, y, width, height, character)
	local o = {};
